...
public class DiscrepancyController implements Initializable{
    ...
    public TableView discrepancyTable;
    public TableColumn discrepancyID;
    public TableColumn itemID;
    public TableColumn unitsLost;
    public TableColumn dateReported;
    public TableColumn reportedBy;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Platform.runLater(() -> {
            discrepancyID.setCellValueFactory(new PropertyValueFactory<>("discrepancy_id"));
            itemID.setCellValueFactory(new PropertyValueFactory<>("item_id"));
            unitsLost.setCellValueFactory(new PropertyValueFactory<>("units_lost"));
            dateReported.setCellValueFactory(new PropertyValueFactory<>("date_reported"));
            reportedBy.setCellValueFactory(new PropertyValueFactory<>("staff_id"));
            ObservableList<Discrepancy> observableList = FXCollections.observableList(collectiveData.getDiscrepancies());
            discrepancyTable.setItems(observableList);
        });
    }
    ...
    public void inventoryBtnClicked(ActionEvent actionEvent) throws IOException {
